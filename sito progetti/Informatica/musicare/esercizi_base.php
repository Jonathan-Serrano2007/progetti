...
$sql = "SELECT u.id_ruolo FROM utenti u WHERE u.id_utente = ?";
try {
...
$sql_esercizi = "SELECT * FROM esercizi WHERE tipo_esercizio = 'base' ORDER BY difficolta ASC";
try {
...
$sql_progress = "SELECT * FROM svolge WHERE id_utente = ? ORDER BY data_completamento DESC LIMIT 10";
try {
