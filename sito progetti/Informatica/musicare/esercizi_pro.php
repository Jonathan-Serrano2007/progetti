<?php
/**
 * Pagina Esercizi Avanzati (PRO)
 * Accessibile solo da utenti con ruolo PRO e ADMIN
 */
...
<head>
    ...
    <title>Esercizi Avanzati - Musicare</title>
...
<body>
    ...
    <div class="container container-main">
        <h1 class="page-title">
            <i class="bi bi-star"></i> Esercizi Avanzati <span class="pro-badge">PRO</span>
        </h1>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="label">Esercizi Avanzati</div>
            </div>
            <div class="stat-card">
                <div class="number"><?php echo count($progressi); ?></div>
                <div class="label">Totali Completati</div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                <div class="number"><?php 
                    ...
                    if (!empty($progressi)) {
                        $totale = 0;
                        foreach ($progressi as $p) {
                            if ($p['tempo_impiegato']) $totale += $p['tempo_impiegato'];
                        }
                        $tempo_medio = round($totale / count($progressi), 1);
                    }
                    echo $tempo_medio;
                ?></div>
                    ...
                    <div class="col-md-6">
                        <div class="exercise-card">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <a href="#" class="btn btn-svolgi ms-2" onclick="svolgiEsercizio(<?php echo $esercizio['id_esercizio']; ?>)">
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="exercise-card text-center">
                        <p>Nessun esercizio avanzato disponibile al momento.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <script>
        function svolgiEsercizio(idEsercizio) {
            alert('Esercizio Avanzato #' + idEsercizio + ' - Funzionalità in sviluppo');
        }
    </script>
